...
To allocate a buffer, you can either directly use the :func:`constructor <vkdispatch.Buffer.__init__>` of the `Buffer` class or the :func:`vd.asbuffer <vkdispatch.asbuffer>` function to directly upload a numpy array to the gpu as a buffer.
