...
def test_rfft_2d_batch():
    ...
    # Perform an FFT on the buffer
    vd.vkfft.rfft(test_img, axes=[1, 2])
...
def test_convolution_2d():
    ...
    vd.vkfft.create_kernel_2Dreal(kernel_img)

    # Perform an FFT on the buffer
    vd.vkfft.convolve_2Dreal(test_img, kernel_img, input=input_buffer, normalize=True)
